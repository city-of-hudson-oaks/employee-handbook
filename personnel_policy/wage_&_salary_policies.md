## 3. Wage & Salary Policies {#wage-salary-policies}
...
In most instances, employee salaries \(other than certain police personnel\) are based on a forty-hour work week for fifty-two weeks each year \(2,080 hours per year\). Where regular employment is less than full time \(less than 35 hours per week\), the employee’s salary will be based on the actual number of hours worked times the hourly rate of pay established for that position. Police personnel’s salaries are based on a forty two-hour work week for fifty two weeks each year \(2,184 hours per year\).
